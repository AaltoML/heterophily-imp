...
from hetflow.models.utils import check_validity, construct_mol, adj_to_smiles
from hetflow.utils.model_utils import load_model, get_latent_vec, smiles_to_adj
from hetflow.utils.molecular_metrics import MolecularMetrics
...
def optimize_mol(model:MoFlow, property_model:MoFlowProp, smiles, device, sim_cutoff, lr=2.0, num_iter=20,
    ...
    print(f'valid/generated: {len(valid_smiles)}/{adj.shape[0]}')
    print(f'unique/generated: {len(set(valid_smiles))}/{adj.shape[0]}')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--hyperparams_path", type=str, default='moflow-params.json', required=False)
